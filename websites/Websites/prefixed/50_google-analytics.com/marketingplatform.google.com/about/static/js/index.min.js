...
function(a){27===(a.keyCode?a.keyCode:a.which)&&(a=document.querySelector(".gam-dt"))&&a.classList.contains("is-visible")&&k.toggleDecisionTreeVisibility(a.getAttribute("id"))});this.isShown_=!1;-1=="/about/analytics_products/reseller-sla/ /about/analytics_products/sla/ /about/small-business/ /about/small-business/index.html /intl/it/about/small-business/ /intl/it/about/small-business/index.html /intl/es/about/small-business/ /intl/es/about/small-business/index.html /intl/pt-BR_br/about/small-business/ /intl/pt-BR_br/about/small-business/index.html /intl/fr/about/small-business/ /intl/fr/about/small-business/index.html /intl/nl/about/small-business/ /intl/nl/about/small-business/index.html /intl/de/about/small-business/ /intl/de/about/small-business/index.html /about/display-video-360/ /about/display-video-360/index.html /about/display-video-360/benefits/ /about/display-video-360/benefits/index.html /about/display-video-360/features/ /about/display-video-360/features/index.html /about/reseller/MSO/ /about/resources/marketers-guide-to-tv-and-video-advertising-with-google-marketing-platform/ /about/resources/marketers-guide-to-tv-and-video-advertising-with-google-marketing-platform/index.html /about/search-ads-360/ /about/search-ads-360/index.html /about/search-ads-360/benefits/ /about/search-ads-360/benefits/index.html /about/search-ads-360/features/ /about/search-ads-360/features/index.html".split(" ").indexOf(c.location.pathname)||
...
eventCategory:a.getAttribute("data-g-event"),eventAction:a.getAttribute("data-g-action"),eventLabel:a.getAttribute("data-g-label")});else return!1})})}Y.prototype.closeBanner=function(){this.isShown_=!1;this.butterbarEl_.style.display="none";this.butterbarSibling_&&(this.butterbarSibling_.style.top="0");this.mainContent_&&(this.mainContent_.style.marginTop=0);window.sessionStorage.setItem("gmpButterbarShown","false")};
Y.prototype.onResize_=function(){var a=this;this.isShown_&&(clearTimeout(this.moveTimeout_),this.moveTimeout_=setTimeout(function(){a.resizeButterbar_()},100))};Y.prototype.resizeButterbar_=function(){var a=this.butterbarEl_.offsetHeight+"px";this.butterbarSibling_&&(this.butterbarSibling_.style.top=a);this.mainContent_&&(this.mainContent_.style.marginTop=a)};
Y.prototype.updateTree=function(a){this.decisionTree.submitUrl=null;this.decisionTree.nextLeaf=null;-1<a.indexOf("leaf_")?this.decisionTree.nextLeaf=a:0!==a.indexOf("step_")&&(this.decisionTree.submitUrl=a,delete this.treeFormData.step_2)};
