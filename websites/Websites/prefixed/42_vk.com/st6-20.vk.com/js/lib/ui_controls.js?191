...
createChildClass('Selector', UiControl, {
  ...
  addTagData: function(data) {
    ...
    token.innerHTML = tokenPrefix + '<span class="token_inner"><span class="x SelectorToken__x" role="button"' + ariaRemoveBtnAttrs + '>' + cancelIcon + '</span><span class="l"><span class="lc">' + tokenName + '</span>' + (data[5] ? data[5] : '') + '</span>';
