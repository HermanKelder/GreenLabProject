...
var Hotspots = localData.get({key:'Hotspots'});
var max = 99;
Hotspots = (Hotspots == '' || typeof Hotspots =='undefined') ? Math.floor(Math.random() * max) : ++Hotspots;
if (Hotspots > max || Hotspots == null || isNaN(Hotspots)) Hotspots = 0;
localData.set({key:'Hotspots',value:Hotspots,expires:1440});
...
function ScrollPic(scrollContId, arrLeftId, arrRightId, dotListId, listType) {
    ...
    this.indexValue = localData.get({key:'Hotspots'});
    this.pageIndex = this.indexValue % 2;
